...
export class ApiService {
  ...
  private ALL_NOTES_BY_NOTEBOOK_URL= `${this.BASE_URL}\\notes\\byNotebook\\`;
  ...
  deleteNotebooks(id:string) : Observable<any>{
  ...
  getAllNotesByNotebook(id:string) : Observable<Note[]>{
    return this.http.get<Note[]>(this.ALL_NOTES_BY_NOTEBOOK_URL+id);
  }
